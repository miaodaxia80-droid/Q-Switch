...
| 文件 | 内容 |
|------|------|
| [qoder-routing-guide-zh.md](../../guides/qoder-routing-guide-zh.md) | Qoder 原生 BYOK、Q Switch 本地路由、当前限制与验证方法 |
...
- **接入 Qoder 自定义模型**：查看 [Qoder 路由专题](../../guides/qoder-routing-guide-zh.md)
- **遇到问题**：查看 [5.2 FAQ](./5-faq/5.2-questions.md)

## 版本信息

- 文档版本：feature/qoder-support
- 最后更新：2026-07-28
- 适用于 CC Switch Q Switch 分支（Qoder 路由仍为实验性功能）

### Q Switch 分支新增内容

- **Qoder 原生 BYOK 本地路由（实验性）**：映射 Qoder 自定义载体模型至 Q Switch 后，已完成 Quest 普通对话、流式输出与受限只读工具调用的 UI 回归；终端、写入、网络和 MCP 已实现为默认关闭的逐项授权，尚需真机 UI 回归 — 详见 [Qoder 路由专题](../../guides/qoder-routing-guide-zh.md)
