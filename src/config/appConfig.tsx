...
export const MCP_APP_IDS: AppId[] = [...SKILLS_APP_IDS, "qoder"];
...
export const APP_ICON_MAP: Record<AppId, AppConfig> = {
  ...
  qoder: {
    ...
    activeClass:
      "bg-fuchsia-500/10 ring-1 ring-fuchsia-500/20 hover:bg-fuchsia-500/20 text-fuchsia-700 dark:text-fuchsia-300",
    badgeClass:
