...
function ProviderFormFull({
  ...
  const supportsFullUrl = appId === "claude" || appId === "codex" || appId === "qoder";
  ...
  useEffect(() => {
    if ((appId === "codex" || appId === "qoder") && !initialData && selectedPresetId === "custom") {
  ...
  const {
    ...
    initialData: (appId === "codex" || appId === "qoder") ? initialData : undefined,
    initialEnabled:
      (appId === "codex" || appId === "qoder") ? initialData?.meta?.commonConfigEnabled : undefined,
    selectedPresetId: selectedPresetId ?? undefined,
  });
  ...
  const shouldApplyLocalProxyRequestOverrides =
    (appId === "claude" || appId === "codex" || appId === "qoder") && category !== "official";
  ...
  const handleSubmit = async (values: ProviderFormData) => {
    ...
    if (category !== "official" && category !== "cloud_provider") {
      ...
      } else if (appId === "codex" || appId === "qoder") {
      ...
      apiFormat:
        appId === "claude" && category !== "official"
          ? isXaiOauthProvider
            ? "openai_responses"
            : localApiFormat
          : (appId === "codex" || appId === "qoder") && category !== "official"
            ? isXaiOauthProvider
              ? "openai_responses"
              : localCodexApiFormat
            : undefined,
    ...
    <>
      <Form {...form}>
        ...
        >
          ...
          {/* 配置编辑器：Codex/Qoder、Claude、Gemini 分别使用不同的编辑器 */}
          {appId === "codex" || appId === "qoder" ? (
            <>
              <CodexConfigEditor
                authValue={codexAuth}
