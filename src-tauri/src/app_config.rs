...
pub struct McpApps {
    ...
    #[serde(default)]
    pub hermes: bool,
    /// Qoder runs MCP through the Q Switch ACP adapter rather than by
    /// rewriting Qoder's own application files.
    #[serde(default)]
    pub qoder: bool,
}
...
impl SkillApps {
    ...
    pub fn set_enabled_for(&mut self, app: &AppType, enabled: bool) {
        match app {
            ...
            AppType::Qoder => {}         // Qoder does not expose a Skill directory
        }
    }
...
impl FromStr for AppType {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        match normalized.as_str() {
            ...
            "qoder" => Ok(AppType::Qoder),
            other => Err(AppError::localized(
                "unsupported_app",
                format!("不支持的应用标识: '{other}'。可选值: claude, claude-desktop, codex, gemini, grokbuild, opencode, openclaw, hermes, qoder。"),
                format!("Unsupported app id: '{other}'. Allowed: claude, claude-desktop, codex, gemini, grokbuild, opencode, openclaw, hermes, qoder."),
            )),
        }
    }
}
...
impl CommonConfigSnippets {
    ...
    pub fn get(&self, app: &AppType) -> Option<&String> {
        match app {
            ...
            AppType::Qoder => self.qoder.as_ref(),
        }
    }
    ...
    pub fn set(&mut self, app: &AppType, snippet: Option<String>) {
        match app {
            ...
            AppType::Qoder => self.qoder = snippet,
        }
    }
}
...
impl MultiAppConfig {
    ...
    pub fn mcp_for_mut(&mut self, app: &AppType) -> &mut McpConfig {
        match app {
            ...
            AppType::Qoder => &mut self.mcp.qoder,
        }
    }
    ...
    fn auto_import_prompt_if_exists(config: &mut Self, app: AppType) -> Result<bool, AppError> {
        ...
        let prompts = match app {
            ...
            AppType::Qoder => &mut config.prompts.qoder.prompts,
        };
    ...
    pub fn migrate_mcp_to_unified(&mut self) -> Result<bool, AppError> {
        ...
        for app in [
            ...
            let old_servers = match app {
                ...
                AppType::Qoder => continue,    // Qoder is new and has no legacy MCP bucket
            };
